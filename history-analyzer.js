...
import { parseRelationList } from './render/relations-graph.js?v=22.99.91';
import { nameLettersOnly, namePhoneticLatin } from './names.js?v=22.99.91';
import { hudFilled, getSafeUserName } from './utils.js?v=22.99.91';
import { createDashboard } from './chat-stats.js?v=22.99.91';
import { статусРужья } from './codes.js?v=22.99.91';
import { readEntry, writeEntry, clearAll, usage } from './store.js?v=22.99.91';
...
import { extractHudBlock } from './hud-block.js?v=22.99.91';
