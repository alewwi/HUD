...
import { parseRelationList } from './render/relations-graph.js?v=22.99.93';
import { nameLettersOnly, namePhoneticLatin } from './names.js?v=22.99.93';
import { hudFilled, getSafeUserName } from './utils.js?v=22.99.93';
import { createDashboard } from './chat-stats.js?v=22.99.93';
import { статусРужья } from './codes.js?v=22.99.93';
import { readEntry, writeEntry, clearAll, usage } from './store.js?v=22.99.93';
...
import { extractHudBlock } from './hud-block.js?v=22.99.93';
