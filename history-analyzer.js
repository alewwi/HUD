...
import { parseHUDComplex } from './hud-parser.js?v=22.99.76';
import { normalizeJSONData } from './schema.js?v=22.99.76';
import { parseRelationList } from './render/relations-graph.js?v=22.99.76';
import { nameLettersOnly, namePhoneticLatin } from './names.js?v=22.99.76';
import { hudFilled, getSafeUserName } from './utils.js?v=22.99.76';
import { createDashboard } from './chat-stats.js?v=22.99.76';
import { статусРужья } from './codes.js?v=22.99.76';
import { readEntry, writeEntry, clearAll, usage } from './store.js?v=22.99.76';
...
import { extractHudBlock } from './hud-block.js?v=22.99.76';
