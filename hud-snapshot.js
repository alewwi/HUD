...
import { свернутьКоды, НАЗВАНИЯ_КОДОВ } from './codes.js?v=23.7.5';
import { разобратьHUDСырой } from './hud-parser.js?v=23.7.5';
import { заменитьHudБлоки } from './hud-block.js?v=23.7.5';
