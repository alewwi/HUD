...
import { свернутьКоды, НАЗВАНИЯ_КОДОВ } from './codes.js?v=23.4.6';
import { разобратьHUDСырой } from './hud-parser.js?v=23.4.6';
import { заменитьHudБлоки } from './hud-block.js?v=23.4.6';
