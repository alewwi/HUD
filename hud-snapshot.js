...
import { mapKey } from './utils.js?v=22.99.93';
import { свернутьКоды, НАЗВАНИЯ_КОДОВ } from './codes.js?v=22.99.93';
import { разобратьHUDСырой } from './hud-parser.js?v=22.99.93';
