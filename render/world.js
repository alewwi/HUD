...
import { escapeHtml, hudHashSeed, commentInitials, hudHasMeaningfulValue } from '../utils.js?v=23.9.2';
import { HUD_AVATAR_COLORS } from '../avatars.js?v=23.9.2';
import { buildEconomyHTML, buildEventsHTML, buildCityHTML } from './world-city.js?v=23.9.2';
