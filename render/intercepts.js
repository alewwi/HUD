...
import { escapeHtml, defeatWI, hudHasMeaningfulValue, sanitizeText } from '../utils.js?v=23.9.2';
import { overrideAvatarUrl } from '../avatars.js?v=23.9.2';
...
import { собратьЛенту, моментПоследнего } from './msg-feed.js?v=23.9.2';
