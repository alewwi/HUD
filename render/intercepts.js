...
import { escapeHtml, defeatWI, hudHasMeaningfulValue } from '../utils.js?v=22.98.0';
import { overrideAvatarUrl } from '../avatars.js?v=22.98.0';
...
import { buildBubbleInner, msgKey, buildCallRow } from './msg-parts.js?v=22.98.0';
