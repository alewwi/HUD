...
import { escapeHtml, defeatWI, hudHashSeed, sanitizeText } from '../utils.js?v=22.99.93';
import { HUD_AVATAR_COLORS } from '../avatars.js?v=22.99.93';
import { G_ICONS } from './icons.js?v=22.99.93';
import { собратьЛенту } from './msg-feed.js?v=22.99.93';
import { avaFace, msgTimeOf, collectCounterparts } from './phone-common.js?v=22.99.93';
