...
import { escapeHtml, defeatWI, hudHashSeed } from '../utils.js?v=22.88.3';
import { HUD_AVATAR_COLORS } from '../avatars.js?v=22.88.3';
import { G_ICONS } from './icons.js?v=22.88.3';
import { buildBubbleInner, buildCallRow, msgKey } from './msg-parts.js?v=22.88.3';
import { avaFace, msgTimeOf, collectCounterparts } from './phone-common.js?v=22.88.3';
import { namesLikelySame } from '../names.js?v=22.88.3';
