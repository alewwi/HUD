...
import { escapeHtml, defeatWI, hudHashSeed, sanitizeText } from '../utils.js?v=23.9.2';
import { HUD_AVATAR_COLORS } from '../avatars.js?v=23.9.2';
import { G_ICONS } from './icons.js?v=23.9.2';
import { собратьЛенту } from './msg-feed.js?v=23.9.2';
import { avaFace, msgTimeOf, collectCounterparts } from './phone-common.js?v=23.9.2';
