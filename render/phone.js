...
import { escapeHtml, defeatWI, hudHashSeed, guardTouchSwipe } from '../utils.js?v=22.88.3';
import { settings } from '../settings.js?v=22.88.3';
import { HUD_AVATAR_COLORS, overrideAvatarUrl } from '../avatars.js?v=22.88.3';
import { G_ICONS } from './icons.js?v=22.88.3';
import { buildMessengerHTML } from './messenger.js?v=22.88.3';
import { avaFace, msgTimeOf, collectCounterparts, parseMsgParties } from './phone-common.js?v=22.88.3';


import { namesLikelySame, transliterateCyrillic } from '../names.js?v=22.88.3';
