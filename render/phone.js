...
import { escapeHtml, defeatWI, hudHashSeed, guardTouchSwipe, sanitizeText } from '../utils.js?v=22.99.58';
import { settings } from '../settings.js?v=22.99.58';
import { HUD_AVATAR_COLORS, overrideAvatarUrl } from '../avatars.js?v=22.99.58';
import { G_ICONS } from './icons.js?v=22.99.58';
import { buildMessengerHTML } from './messenger.js?v=22.99.58';
import { avaFace, msgTimeOf, collectCounterparts, parseMsgParties } from './phone-common.js?v=22.99.58';


import { namesLikelySame, transliterateCyrillic } from '../names.js?v=22.99.58';
