...
import { escapeHtml, defeatWI, hudHashSeed, guardTouchSwipe } from '../utils.js?v=22.98.0';
import { settings } from '../settings.js?v=22.98.0';
import { HUD_AVATAR_COLORS, overrideAvatarUrl } from '../avatars.js?v=22.98.0';
import { G_ICONS } from './icons.js?v=22.98.0';
import { buildMessengerHTML } from './messenger.js?v=22.98.0';
import { avaFace, msgTimeOf, collectCounterparts, parseMsgParties } from './phone-common.js?v=22.98.0';


import { namesLikelySame, transliterateCyrillic } from '../names.js?v=22.98.0';
