 ...
 * Цвета — из семьи акцента темы (--hud-tone-base пишет palette.js): на розовой
 * теме — оттенки розового, на винной — вина и багрянца. Радуга с жёлтым,
 * оранжевым и зелёным выбивалась из темы. Светлота умеренная: на кружке
 * белые инициалы. Тон уводим от акцента не дальше, чем секции карточки.
 */
const тонАватарки = (сдвиг, s, l) => `hsl(calc(var(--hud-tone-base, 330) + ${сдвиг}) ${s}% ${l}%)`;
export const HUD_AVATAR_COLORS = [
  тонАватарки(0, 62, 42), тонАватарки(-12, 52, 34), тонАватарки(8, 46, 48), тонАватарки(-18, 48, 42),
  тонАватарки(4, 70, 30), тонАватарки(-6, 38, 50), тонАватарки(-14, 64, 46), тонАватарки(10, 56, 36),
];
